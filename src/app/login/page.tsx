  ...
  <main className="min-h-[calc(100vh-7rem)] flex items-center justify-center">
      <div className="w-full max-w-4xl bg-white rounded-2xl shadow-md overflow-hidden pt-8">
        <div className="max-w-2xl mx-auto text-center p-8">
          <h1 className="text-3xl font-bold text-emerald-900 tracking-wide">Select Your Dashboard</h1>
          <p className="mt-2 text-[15.5px] leading-8 text-slate-700">Select the role you would like to log in/sign up.</p>

          <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6 items-stretch">
            <Link href="/booking" className="flex flex-col items-center justify-center gap-3 rounded-lg bg-white ring-1 ring-slate-200 p-6 text-center hover:shadow-lg transition">
            ...
            <Link href="/login/member" className="flex flex-col items-center justify-center gap-3 rounded-lg bg-white ring-1 ring-slate-200 p-6 text-center hover:shadow-lg transition">
              <div className="w-16 h-16 relative">
